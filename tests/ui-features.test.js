...
test('frontend exposes required runtime configuration features', () => {
  ...
  assert.match(appJs, /toolbar-action-group data-entry-group/);
  assert.match(appJs, /toolbar-action-group data-mutation-group/);
  assert.match(appJs, /toolbar-action-group view-rule-group/);
  assert.match(appJs, /toolbar-action-group structure-config-group/);
  assert.match(appJs, /toolbar-action-group export-action-group/);
  assert.match(appJs, /buttonLabel\('filter', '筛选'\)/);
